...
export default function Home() {
    ...
    return (
        <div className="container flex flex-col items-center justify-center mt-8 space-y-3 px-52">
            <form className='flex flex-col w-6/12 p-8 space-y-3 bg-gray-700 rounded' action="#" method='POST'>
                <h2 className='text-3xl font-bold text-white poppins'>Where does the money go?</h2>
                <h3 className='text-white'>The money you donate goes to whatever I want to spend it on!</h3>
